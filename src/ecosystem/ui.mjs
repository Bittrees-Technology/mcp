...
export function renderConnectionPage(
  ...
  </style></head><body><a class="skip" href="#main">Skip to content</a><header><a class="brand" href="/">Bittrees MCP</a><nav aria-label="Primary"><a href="/connect" aria-current="page">Connect</a><a href="/projects">Projects</a><a href="/automations">Automations</a><a href="/rules">Rules</a><a href="/reference">Functions & endpoints</a><a href="/status">Status</a><a href="https://agent.bittrees.org">Agent onboarding</a></nav></header><main id="main"><p class="badge">Public project context · scoped automation</p><p>Connect public project context here. Existing Agent contribution clients can keep their original endpoint during migration.</p><h1>Choose your projects. Connect your agent.</h1><p>Discover project documentation, integration status, and reviewed handoff routes. Private accounts and product actions need separate project authorization.</p>
